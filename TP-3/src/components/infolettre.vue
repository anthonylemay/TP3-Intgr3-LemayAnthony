        ...
        <form @submit.prevent="valider">
          <div class="flexRow">
            <div class="flexCol formName">
              ...
              <p class="error" v-if="newSub.erreurs.prenom">
            ...
            <div class="flexCol formName">
              ...
              <p class="error" v-if="newSub.erreurs.nom">
          ...
          <div class="flexCol">
            ...
            <p class="error" v-if="newSub.erreurs.email">
              Veuillez inscrire votre courriel.
            </p>
          </div>

          <div>
            <label class="checkBoxText" for="check"
              >Vous consentez à recevoir des offres et des nouvelles de notre
              site :</label
            >
            <input
              class="checkBox"
              type="checkbox"
              id="check"
              v-model="newSub.checkBox"
            />
            <p class="error" v-if="newSub.erreurs.checkBox">
              Veuillez valider votre consentement.
            </p>
          </div>
